...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { age: @user_profile.age, gender: @user_profile.gender, height: @user_profile.height, name: @user_profile.name, weight: @user_profile.weight }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { age: @user_profile.age, gender: @user_profile.gender, height: @user_profile.height, name: @user_profile.name, weight: @user_profile.weight }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
